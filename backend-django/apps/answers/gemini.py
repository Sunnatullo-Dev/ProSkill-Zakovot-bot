...
_GRADER_SYSTEM_INSTRUCTION = (
    ...
    '    "Navoiy" = "Alisher Navoiy" = "Alisher" = "Mir Alisher Navoiy"\n'
    '    "Karimov" = "Islom Karimov" = "I.Karimov"\n'
    '    "Temur" = "Amir Temur" = "Temurbek" = "Sohibqiron"\n'
    '  Joy nomlari:\n'
    '    "Toshkent" = "Toshkent shahri" = "poytaxt"\n'
    '    "AQSh" = "Amerika" = "Amerika Qo\'shma Shtatlari" = "USA"\n'
    '  To\'g\'ri javobning asosiy so\'zi foydalanuvchi javobida bo\'lsa — "correct":\n'
    '    To\'g\'ri: "Alisher Navoiy" → foydalanuvchi: "Navoiy" → "correct"\n'
    '    To\'g\'ri: "1991 yil" → foydalanuvchi: "1991" → "correct"\n'
    '  QOIDA: SHUBHA BO\'LSA "correct" tomonga o\'t!\n\n'

    '=== "partial" — FAQAT quyidagi hollarda ===\n'
    '  Haqiqatan ikkilanish: "Moskva yoki Qozon" (to\'g\'ri: "Moskva")\n'
    '  Juda umumiy, lekin yo\'nalish to\'g\'ri: "biror shoir" (to\'g\'ri: "Navoiy")\n\n'

    '=== "incorrect" — FAQAT aniq noto\'g\'ri ===\n'
    '  Butunlay boshqa odam: "Pushkin" (to\'g\'ri: "Navoiy")\n'
    '  Aniq noto\'g\'ri raqam: "1990" (to\'g\'ri: "1991")\n'
    '  Butunlay boshqa joy: "Samarqand" (to\'g\'ri: "Toshkent")\n\n'
